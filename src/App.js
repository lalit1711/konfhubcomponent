...
function App() {
  ...
  return (
    ...
    <ToolTip />
      ...
      &nbsp;
      <br/>
      <InputBox setInputData={setInputData} type="date" name="Enter Email" isRequired={true} case="none" value="" leftIcon="calendar" rightIcon="check" notification={{on:true,data:"this is notification"}}  />
      ...
      <br />
      <span onMouseOver={e =>{ console.log("mouse over")}} draggable={true}>Primary
      </span>
    </div>
  );
}
